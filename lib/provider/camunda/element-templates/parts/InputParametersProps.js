...
module.exports = function(group, element, elementTemplates, bpmnFactory, translate) {
  ...
  function renderInputParameter(id, templateProperty) {
    ...
    var assignmentIsOn = function() {
      ...
      return isOpen() && !!parameter;
    };

    var options = {
      idPrefix: id + '-',
      onToggle: onToggle,
      isOpen: assignmentIsOn
    };
    ...
    parameterEntries.splice(templateProperty.description ? 2 : 1, 0, entryFactory.checkbox({
      ...
      set: function(element, values, node) {
        ...
        // todo(pinussilvestrus): this forces a full rerender, since parameter was removed or added
        if (isActive) {
